...
int main ()
{
  ...
  nu::int1*           m_overflow      = new nu::int1 (11);                                          // Rejection samplign overflow.
  nu::float1*         parameter       = new nu::float1 (12);                                        // Parameters array.
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    if(hud->button ("[U]pdate", 100) || gl->key_U)
    {
      ...
      cl->write (12);                                                                               // Updating all parameters...
    ...
    hud->plot ("<phi>", "<phi>", "stderr(phi)", phi_avg, phi_stderr, 0.1f*dt);                      // Plotting average spin-z and its standard deviation...
    hud->lineplot ("Potential energy", "phi", "V", data_x, data_y);                                 // Plotting potential energy profile...

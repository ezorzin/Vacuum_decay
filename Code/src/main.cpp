...
int main ()
{
  ...
  parameter->data.push_back ((float)M_MAX);                                                         // Setting maximum allowed number of rejections...
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    if(hud->button ("(U)pdate", 100) || gl->key_U)
    {
      ...
      parameter->data[0]  = (float)M_MAX;                                                           // Setting maximum allowed number of rejections...
      parameter->data[1]  = c_1;                                                                    // Setting c_1 parameter...
      parameter->data[2]  = c_2;                                                                    // Setting c_2 parameter...
      parameter->data[3]  = lambda;                                                                 // Setting lambda parameter...
      parameter->data[4]  = mu;                                                                     // Setting mu parameter...
      parameter->data[5]  = T;                                                                      // Setting T parameter...
      parameter->data[6]  = T_hat;                                                                  // Setting T_hat parameter...
      parameter->data[7]  = phi_max;                                                                // Setting phi_max parameter...
      parameter->data[8]  = alpha;                                                                  // Setting radial exponent...

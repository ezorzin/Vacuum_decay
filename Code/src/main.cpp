...
int main ()
{
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    if(dt > 0.0f)
    {
      ...
      m_level   /= nodes;                                                                           // Computing rejection sampling overflow level...
    ...
    hud->plot ("<phi>", "<phi>", "stderr(phi)", phi_avg, phi_stderr, 0.1f*dt);                      // Plotting average phi and its standard deviation...
    hud->plot ("m_level", "m_level", "m_level", m_level, m_level, 0.1f*dt);                         // Plotting m_level...

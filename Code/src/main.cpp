...
int main ()
{
  ...
  nu::float1*         T_parameter       = new nu::float1 (10);                                      // T parameter.
  nu::float1*         T_hat_parameter   = new nu::float1 (11);                                      // T_hat parameter.
  nu::float1*         phi_max_parameter = new nu::float1 (12);                                      // phi_max parameter.
  ...
  nu::float1*         c_1_parameter     = new nu::float1 (19);                                      // c_1 parameter.
  ...
  columns->data.push_back ((int)side_x_nodes);                                                      // Setting number of mesh columns...
  ...
  c_1_parameter->data.push_back (c_1);                                                              // Setting c_1 parameter...
  //c_2_parameter->data.push_back (c_2);                                                              // Setting c_2 parameter...
  //lambda_parameter->data.push_back (lambda);                                                        // Setting lambda parameter...
  //mu_parameter->data.push_back (mu);                                                                // Setting mu parameter...
  T_parameter->data.push_back (T);                                                                  // Setting T parameter...
  T_hat_parameter->data.push_back (T_hat);                                                          // Setting T_hat parameter...
  phi_max_parameter->data.push_back (phi_max);                                                      // Setting phi_max parameter...
  ...
  while(!gl->closed ())                                                                             // Opening window...
  {
    ...
    cl->read (19);                                                                                  // Reading spin_z_row_sum...
    cl->read (20);                                                                                  // Reading spin_z2_row_sum...
    ...
    hud->input ("Radial exponent:                   ", "[]    ", "alpha", &alpha);                  // alpha parameter...

    if(hud->button ("(U)pdate", 100) || gl->key_U)
    {
      // UPDATING PHYSICAL PARAMETERS:
      phi_max_parameter->data[0] = phi_max;                                                         // Setting phi_max parameter...
      //c_1_parameter->data[0]     = c_1;                                                             // Setting c_1 parameter...
      //c_2_parameter->data[0]     = c_2;                                                             // Setting c_2 parameter...
      //lambda_parameter->data[0]  = lambda;                                                          // Setting lambda parameter...
      //mu_parameter->data[0]      = mu;                                                              // Setting mu parameter...
      T_parameter->data[0]       = T;                                                               // Setting T parameter...
      T_hat_parameter->data[0]   = T_hat;                                                           // Setting T_hat parameter...
      radial_exponent->data[0]   = alpha;                                                           // Setting radial exponent...

      cl->write (10);                                                                               // Updating c_1 parameter...
      cl->write (11);                                                                               // Updating c_2 parameter...
      cl->write (12);                                                                               // Updating lambda parameter...
      cl->write (13);                                                                               // Updating mu parameter...
      cl->write (14);                                                                               // Updating T parameter...
      cl->write (15);                                                                               // Updating T_hat parameter...
      cl->write (16);                                                                               // Updating phi_max parameter...
      cl->write (17);                                                                               // Updating radial exponent...
    }
  ...
  //delete c_1_parameter;                                                                             // Deleting c_1 parameter...
  //delete c_2_parameter;                                                                             // Deleting c_2 parameter...
  //delete lambda_parameter;                                                                          // Deleting lambda parameter...
  //delete mu_parameter;                                                                              // Deleting mu parameter...
  delete T_parameter;                                                                               // Deleting T parameter...
  delete T_hat_parameter;                                                                           // Deleting T_hat parameter...
  delete phi_max_parameter;                                                                         // Deleting phi_max parameter...
  delete radial_exponent;                                                                           // Deleting radial exponent...
  delete columns;                                                                                   // Deleting number of columns in mesh.
